  ...
  return (
    <div className="flex-1 overflow-y-auto bg-slate-50/60">
      <TopBar
        ...
        subtitle="Fill in the details below to submit a request"
      >
        <button
      ...
      <div className="p-4 sm:p-6 xl:p-8 max-w-3xl">
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden divide-y divide-slate-50">
            ...
            <div
              ...
              className={`border-2 border-dashed rounded-2xl p-6 sm:p-8 text-center transition-all cursor-pointer ${
                dragging
                  ...
                  : "border-slate-200 hover:border-[#0F766E]/40 hover:bg-slate-50/60"
              }`}
            >
              <Upload
                className={`w-8 h-8 mx-auto mb-3 transition ${dragging ? "text-[#0F766E]" : "text-slate-300"}`}
              />
              <p className="text-sm font-medium text-slate-600">
                Drop files here or{" "}
                <span className="text-[#0F766E] cursor-pointer hover:underline">
                  browse
                </span>
              </p>
          ...
          {/* Footer */}
          <div className="px-4 sm:px-6 py-4 bg-slate-50/50 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <button
                onClick={() => onNav("requests")}
                className="w-full sm:w-auto px-5 py-2.5 rounded-xl border border-slate-200 text-sm font-medium text-slate-600 hover:bg-slate-100 transition"
              >
                Save as Draft
              </button>
              <button
                onClick={() => onNav("detail")}
                className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-[#0F766E] text-white text-sm font-semibold hover:bg-[#0D6B64] transition shadow-sm"
              >
                Submit Request
              </button>
            </div>
