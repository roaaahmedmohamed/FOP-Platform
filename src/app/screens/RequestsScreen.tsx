              ...
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50/60">
                  <th className="px-5 py-3">
                    <input
                      type="checkbox"
                      className="rounded w-3.5 h-3.5 accent-[#0F766E]"
                    />
                  </th>
                  {[
                    "ID",
                    ...
                    <th
                      key={h}
                      className="text-left px-3 sm:px-4 py-3 text-[11px] font-semibold text-slate-400 uppercase tracking-wider whitespace-nowrap"
                    >
                      {h}
                    </th>
                  ))}
              ...
              <tbody className="divide-y divide-slate-50">
                {filtered.map((req) => (
                  ...
                  >
                    ...
                    <td className="px-3 sm:px-4 py-3.5 text-xs font-mono text-slate-400 whitespace-nowrap">
                      {req.id}
                    </td>
                    <td className="px-3 sm:px-4 py-3.5 text-sm font-medium text-slate-800 max-w-60 truncate group-hover:text-[#0F766E] transition">
                      {req.title}
                    </td>
                    ...
                    <td className="px-3 sm:px-4 py-3.5 text-xs text-slate-400 whitespace-nowrap">
                      {req.date}
                    </td>
                    <td className="px-3 sm:px-4 py-3.5">
                      <button
