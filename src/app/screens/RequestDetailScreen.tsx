...
export default function RequestDetailScreen({
  ...
  const timeline = [
    {
      time: "Jul 17, 2026 — 09:15 AM",
      event: "Request submitted",
      user: "Sarah Kim",
      type: "created",
    },
    {
      time: "Jul 17, 2026 — 10:02 AM",
      event: "Request assigned to James Park",
      user: "System",
      type: "assign",
    },
    {
      time: "Jul 17, 2026 — 10:45 AM",
      event: "Status changed to In Progress",
      user: "James Park",
      type: "status",
    },
    {
      time: "Jul 17, 2026 — 02:30 PM",
      event: "Site inspection completed",
      user: "James Park",
      type: "update",
    },
    {
      time: "Jul 18, 2026 — 09:00 AM",
      event: "Parts ordered — ETA 2 days",
      user: "James Park",
      type: "update",
    },
  ];
  ...
  const comments = [
    {
      ...
      av: "JP",
      time: "Jul 17 · 2:32 PM",
      body: "Completed initial site inspection. The leak is coming from a corroded pipe junction near the east wall of the server room. Temporary containment has been put in place to protect equipment.",
    },
    {
      author: "Sarah Kim",
      av: "SK",
      time: "Jul 17 · 3:15 PM",
      body: "Thanks for the quick response, James. IT has been notified and additional drainage has been placed. Please expedite the parts order given the proximity to critical infrastructure.",
    },
    {
      author: "James Park",
      av: "JP",
      time: "Jul 18 · 9:05 AM",
      body: "Parts ordered from the approved vendor — order #ORD-7821. Expected delivery Jul 20. Full repair scheduled for Jul 21 morning.",
    },
  ];
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-slate-50/60">
      ...
      <div className="p-4 sm:p-6 xl:p-8 grid grid-cols-1 xl:grid-cols-3 gap-6">
        {/* Main */}
        <div className="xl:col-span-2 space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
              <div>
                ...
                <p className="text-sm text-slate-400 mt-1">
                  Submitted by Sarah Kim · {req.date}
                </p>
              </div>
            ...
            <div className="bg-slate-50 rounded-xl p-4 text-sm text-slate-600 leading-relaxed">
              Active water leak detected in the server room (Basement B1). Water
              is pooling near the east wall junction and poses a risk to active
              server racks 03 and 04. Immediate action required. The leak
              appears to stem from a corroded pipe junction above the ceiling
              tiles. IT department has been notified and equipment protection
              ...
              {timeline.map((item, i) => (
                <div key={i} className="flex gap-3 sm:gap-4">
                  <div className="flex flex-col items-center">
                    <div
                      className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 ${timelineIconClass(item.type)}`}
                    >
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
            ...
            <div className="space-y-3">
              {[
                ...
                {
                  label: "Priority",
                  value: <PriorityBadge priority={req.priority} />,
                },
                {
                  label: "Category",
                  value: (
